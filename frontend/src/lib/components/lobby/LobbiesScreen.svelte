    ...
    <div class="lobbies-header">
        ...
        <div class="header-actions">
            {#if currentView === 'lobbies'}
                <button type="button" class="settings-button" onclick={() => currentView = 'settings'}>⚙ Settings</button>
            {:else}
                <button type="button" class="settings-button" onclick={() => currentView = 'lobbies'}>← Torna alle Lobbies</button>
            {/if}
    ...
    <div class="lobbies-content">
        {#if currentView === 'lobbies'}
            <div class="controls">
                ...
                <button type="button" class="refresh-button" onclick={() => (showCreateForm = !showCreateForm)} disabled={storeLobby.isInLobby}>
                    {showCreateForm ? "✕ Cancel" : "+ Create Lobby"}
                </button>
                <button type="button" class="refresh-button" onclick={() => (showJoinForm = !showJoinForm)} disabled={storeLobby.isInLobby}>
